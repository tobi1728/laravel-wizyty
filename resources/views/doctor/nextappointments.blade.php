            ...
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                <header>
                    <h2 class="text-lg font-medium text-gray-900">
                        {{ __('Zobacz swoje nadchodzące wizyty') }}
                    </h2>
                </header>
                    ...
                    <tbody>
                        @forelse($nextAppointments as $appointment)
                            <tr>
                                ...
                                <td class="border px-4 py-2">
                                    @switch($appointment->status->appointmentStatusName)
                                        @case('wolna')
                                            Wolna (jeszcze hehe)
                                            @break
                        ...
                        @empty
                            <tr>
                                <td colspan="3" class="text-center p-4">Brak nadchodzących wizyt. Jesteś faja a nie lekarz.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
