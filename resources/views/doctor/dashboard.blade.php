    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="bg-white shadow rounded-lg p-6 flex justify-between">
                ...
                <div>
                    <img src="{{ asset('images/doctor-today.jpg') }}" alt="Wizyty" class="h-64 w-auto">
                </div>
            </div>
            ...
            <div class="bg-white shadow rounded-lg p-6 flex justify-between">
                ...
                <div>
                    <img src="{{ asset('images/doctor-schedule.jpg') }}" alt="Grafik" class="pl-10 h-64">
                </div>
            </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-10">
            <div class="bg-white shadow rounded-lg p-6 flex justify-between">
                ...
                <div>
                    <img src="{{ asset('images/doctor-past.jpg') }}" alt="Historia wizyt" class="pl-10 h-64 w-auto">
                </div>
            </div>
        </div>
    </div>
